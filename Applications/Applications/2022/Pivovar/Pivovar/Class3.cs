    ...
    internal class Hospoda
    {
        ...
        public static void Nalejvarna()
        {
                ...
                if (Sklad.pivo > 0)
                {
                    ...
                    Console.WriteLine("Počet piv: {0} | Počet Vypitých piv: {1} | Pokladna: {2} | Počet lidí: {3}", Sklad.pivo, pocetVypitychPiv, pokladna, pocetLidi);
                    for (int i = 0; i < pocetLidi; i++)
                    {
                        ...
                        {
                            //Console.WriteLine("Došlo nám pivo! Čekám na pivo...");
                        }
                    }
